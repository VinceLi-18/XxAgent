...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  xagentBusinessSkill: 'web-server.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  BusinessSkillRemoteTranscript: 'Public JSON transcript fields are owned by packages/xagent/business-skill/README.md',
  XAgentBusinessSkillLoad: 'Host-private immutable load fields are owned by packages/xagent/backend-client/README.md',
  XAgentBusinessSkillTestRunner: 'Host test admission and settlement are owned by packages/xagent/business-skill/README.md',
  XAgentBusinessSkillPage: 'Public governance pagination is owned by packages/xagent/backend-client/README.md',
  XAgentBusinessSkillDetail: 'Public draft, version and test records are owned by packages/xagent/backend-client/README.md',
  XAgentBusinessSkillCreateInput: 'Public draft creation fields are owned by packages/xagent/backend-client/README.md',
  XAgentBusinessSkillDraftInput: 'Public draft revision fields are owned by packages/xagent/backend-client/README.md',
  XAgentBusinessSkillTestInput: 'Public test admission fields are owned by packages/xagent/backend-client/README.md',
  XAgentBusinessSkillTest: 'Public test execution state is owned by packages/xagent/backend-client/README.md',
  XAgentBusinessSkillVerdict: 'Public human test verdict is owned by packages/xagent/backend-client/README.md',
