...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  'packages/xagent/business-skill': { kind: 'indirect', reason: 'The authenticated provider supplies public catalog and body data; dsh-tool-skill owns all model rendering.' },
