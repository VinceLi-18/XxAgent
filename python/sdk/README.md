...
Install `deepseek-harness-sdk` and its same-revision runtime wheel from a private artifact set produced by the authorized XxAgent checkout. The import module remains `deepseek_harness`:
