...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('forbidden'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('not-found'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('idempotency-conflict'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('unsupported-version'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('service-unavailable'), message: z.string(), details: z.object({}) }),
