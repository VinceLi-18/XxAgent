...
```sh
git clone https://github.com/VinceLi-18/XxAgent.git
cd XxAgent
pnpm install
```
...
[![](https://img.shields.io/badge/powered_by-dsh-4D6BFE?style=flat-square&logo=deepseek&logoColor=white)](https://github.com/VinceLi-18/XxAgent)
