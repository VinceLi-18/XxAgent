...
需要：`agentDefaultModel` · `agents` · `attachments` · `directoryPicker` · `llm` · `sessions` · `sessionQuery` · `tools` · `userInteraction` · `workspace`
...
来源：[`packages/xagent/authorization/src/index.ts:45`](../packages/xagent/authorization/src/index.ts)
...
来源：[`packages/xagent/session-persistence-api/src/index.ts:27`](../packages/xagent/session-persistence-api/src/index.ts)
...
- `@xagent/dsh-principal` — 抽象 `XAgentPrincipalService`（[`packages/xagent/principal/src/index.ts`](../packages/xagent/principal/src/index.ts)）
## 库包（无插件入口）
